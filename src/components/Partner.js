...
{!matches && rows.map((item) => (
      ...
      <Typography variant="body1" sx={{color:"white"}}>Tx Hash : {item.Wallet}</Typography>
     
 
      <Typography variant="body1" sx={{color:"white"}}>ID : {item.userHeadId}</Typography>
     

      <Typography variant="body1" sx={{color:"white"}}>Referral Earning : {item.ReferralEarning}</Typography>
